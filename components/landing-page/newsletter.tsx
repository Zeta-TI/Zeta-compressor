...
// import { AwsClient } from '../../node_modules/aws4fetch/dist/main'
...
export default function Newsletter() {
  ...
  function FormRequisicao() {
    ...
    //     region,
    //   });
    //   await aws.fetch(url, options).then((response: { json: () => Promise<any>; status: any; }) => {
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <form className="w-full lg:w-1/2">
                <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none">
                  ...
                  />
                  <Button 
                    className='text-purple-600 bg-purple-100 hover:bg-white shadow'
                    type='button' 
