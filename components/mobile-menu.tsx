...
import AlertDialogDemo from './radix/alert-dialog'
    ...
    <div className="md:hidden">
      ...
      >
        <ul className="bg-gray-800 px-4 py-2">
          <li>
            <Link href="/dashboard"className="flex font-medium w-full text-purple-600 hover:text-gray-200 py-2 justify-center">
              Dashboard
            </Link>
          </li>
          <li>
